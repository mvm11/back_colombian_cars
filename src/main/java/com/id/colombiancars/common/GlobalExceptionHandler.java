...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorDetail> handleLibraryException(ParkingException parkingException, WebRequest webRequest){
        ErrorDetail errorDetail = new ErrorDetail(new Date(), parkingException.getMessage(), webRequest.getDescription(false));
